...
DO NOT EDIT - This file is auto-generated from YAML schemas.
"""

{{range .Schemas}}from .{{. | schemaName | lower}} import {{. | schemaName}}
{{end}}
__all__ = [
{{range .Schemas}}    "{{. | schemaName}}",
{{end}}]
`
	data := struct {
		Schemas []schema.Schema
	}{Schemas: schemas}
	return g.executeTemplate(tmpl, data, path)
}
